// Synapse Web UI — Organization Settings page (#unit-5).
// Reached via /org/:orgId/settings. Contains org-focused tabs lifted from Settings.tsx:
// profile, members & RBAC, teams, billing, API tokens, and authentication (MFA policy).
  ...
  return (
    <>
      <PageHead
        ...
        title="Org"
        serif="settings"
        sub="Profile, members, teams, billing, and API tokens for this organization."
        actions={
          <span className="db-mono db-muted" style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
            <Icon name="building-2" size={14} /> {org?.name ?? orgId} · {org?.plan}
          </span>
        }
      />
